...
ggplot(grow, aes(x = medicion2, y = lcu, color=tank)) +
  geom_line()


ggplot(grow, aes(x = medicion2, y = lcu, group=tank)) +
  geom_line(color=id)+geom_point()
...
ggplot(data = df1, aes(x = a, y = b, group=1)) + 
  geom_line() + geom_point()

ggplot(data = df1, aes(x = a, y = b)) + 
  geom_line()
